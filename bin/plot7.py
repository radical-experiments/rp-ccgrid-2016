...
from common import PICKLE_DIR, get_ppn, get_resources, \
    ...
    barrier_legend, barrier_colors, BARRIER_FONTSIZE, BARRIER_LINEWIDTH
...
def plot(sids, value, label='', paper=False):
    ...
    df_all.plot(color=colors, fontsize=BARRIER_FONTSIZE, linewidth=BARRIER_LINEWIDTH)
    ...
    mp.pyplot.legend(labels, loc='upper right', fontsize=BARRIER_FONTSIZE)
    if not paper:
