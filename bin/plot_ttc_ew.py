...
if __name__ == '__main__':
    ...
    session_ids = [
        ...
        "rp.session.netbook.mark.016737.0049", # 24
        "rp.session.netbook.mark.016737.0050", # 1
        "rp.session.netbook.mark.016738.0000", # 4
        "rp.session.netbook.mark.016738.0001", # 2
        "rp.session.netbook.mark.016738.0002", # 16
        "rp.session.netbook.mark.016738.0003", # 8
    ]
